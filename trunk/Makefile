...
ifeq ($(JEU),texte)
	SRCS = Auto.c ncursMenu.c Terrain.c Jeu.c ncursJeu.c main.c Survivant.c DesSurvivants.c DesZombies.c Zombie.c
	FINAL_TARGET = mhd_txt
	DEFINE = -D$(OS) -DJEU_NCURSES
else
	SRCS = Auto.c Terrain.c Jeu.c sdlJeu.c sdlMenu.c sdlCredits.c sdlFin.c main.c Survivant.c DesSurvivants.c DesZombies.c Zombie.c
