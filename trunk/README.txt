...
Le but du jeu est de récupérer des survivants (des pandas en l'occurrence placé sur la carte)
...
- dossier data :
	...
	- jeu : contient les différents sprites et images (au format bmp), les musiques et bruitages
		(au format wav) et la police d'écriture (au format ttf)
...
des zombies ne dépend volontairement pas du temps. Cela permet une difficulté et une appréhension différente par 
rapport à la version SDL.
...
Ces librairies n'étant pas toujours toutes présentes voici comment toutes les obtenir :
SDL:
